...
try{
  ...
  //genreテーブルからgenre_codeカラムのデータを取得するためのSQL文を変数$swl_selectに代入
    ...
    <article class="registration">
      ...
      <form action="create.php" method="post" class="registration-form">
        <div>
          ...
          <input type="number" id="book_code" name="book_code" min="0" max="1000000" required>
          ...
          <input type="number" id="stock_quantity" name="stock_quantity" min="0" max="1000000" required>
